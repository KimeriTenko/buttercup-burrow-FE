...
const About = () => {
  return (
    <div name='About' className='w-full h-full bg-[#F8FAF6] text-[#A29682] overscroll-auto scroll-p-8'>
            ...
            <div className='max-w-[1640px] w-full px-4 grid sm:grid-cols-auto gap-8'>
               <div className='sm:text-right pt-8 pb-8 pl-4'>
                ...
                <div>
                    ...
                    <img nameClass='my-4s' src='https://res.cloudinary.com/djfedr7vl/image/upload/v1670781236/ButtercupBurrow/E418CA60-D055-4AC6-9336-75A2FA0377EB_1_105_c_orrci2.jpg' alt='Elizabeth Hines' />
                    ...
                    {/* Grid Item */}
                    <div className='shadow-md shadow-[#A29682] sm:text-right text-2xl pt-8 pb-8 pr-8 pl-8 group container rounded-md justify-center flex object-fill mx-auto content-div'>
                    <img nameClass='my-4s' src='https://res.cloudinary.com/djfedr7vl/image/upload/v1670781236/ButtercupBurrow/BB9C40B1-D3A7-420C-BFC5-6B9AA12A0900_1_105_c_ypc7vs.jpg' alt='Maria Fuerte' />
